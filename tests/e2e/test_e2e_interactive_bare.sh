...
# AC-T7-002: .github-project.env exists with the worktree root (env-only contract).
assert_exists ".github-project.env" "$TMP/.github-project.env"
assert_file_contains ".github-project.env has ANT_TEAM_WORKTREE_ROOT" \
  "$TMP/.github-project.env" 'ANT_TEAM_WORKTREE_ROOT='
# Env is sourceable (every non-comment line is an ANT_TEAM_* export).
