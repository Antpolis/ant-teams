...
mkdir -p "$FIX/templates/opencode/skills/bad/scripts" "$FIX/templates/opencode/skills/good"
printf -- '---\nname: bad\ndescription: b\n---\n\nbad\n'  > "$FIX/templates/opencode/skills/bad/SKILL.md"
printf 'legit but unreadable\n'                            > "$FIX/templates/opencode/skills/bad/scripts/tool.sh"
chmod 000 "$FIX/templates/opencode/skills/bad/scripts/tool.sh"
printf -- '---\nname: good\ndescription: g\n---\n\ngood\n' > "$FIX/templates/opencode/skills/good/SKILL.md"
...
printf -- '---\ndescription: bad\n---\n\nbad body\n'   > "$FIX2/templates/opencode/commands/badcmd.md"
printf -- '---\ndescription: good\n---\n\ngood body\n' > "$FIX2/templates/opencode/commands/goodcmd.md"
chmod 000 "$FIX2/templates/opencode/commands/badcmd.md"
